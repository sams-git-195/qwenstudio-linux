...
Problems in this repository's scripts, patches, CI, install scripts, or in how the packages are built and signed: use GitHub's private vulnerability reporting for this repository (Security tab → "Report a vulnerability").
